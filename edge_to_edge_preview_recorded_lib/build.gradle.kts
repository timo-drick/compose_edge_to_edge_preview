...
val mavenArtifactId = "edge-to-edge-preview-recorded"
...
kotlin {
    ...
    android {
        namespace = "de.drick.compose.edgetoedge.preview.recorded"
...
mavenPublishing {
    ...
    pom {
        name.set("Compose edge to edge preview recorded insets")
        description.set("""
